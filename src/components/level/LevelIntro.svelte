  ...
  <div class="intro-card">
    <div class="intro-top">
      <div class="intro-text">
        <div class="level-badge">{level.act === 0 ? $translate('ui.act_level_act0', { order: level.order }) : $translate('ui.act_level', { act: level.act, order: level.order })}</div>
    ...
    <div class="concept-box">
      <span class="concept-label">{$translate('ui.concept')}</span>
      <p class="concept-text">{level.briefing.concept}</p>
    </div>

    <div class="objectives-preview">
      <span class="objectives-label">{$translate('ui.objectives')}</span>
